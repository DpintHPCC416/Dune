...
class Scatterlet implements Sketchlet{
    ...
    public void copyOf(Scatterlet scatterlet)
    {
        this.isValid = scatterlet.isValid;
        this.address = scatterlet.address;
        this.offsetes = Arrays.copyOf(scatterlet.offsetes, scatterlet.offsetes.length);
        this.values = Arrays.copyOf(scatterlet.values, scatterlet.values.length);
    }
    /**
     * 第一个为绝对地址，后面的为相对的地址
    ...
    public Scatterlet(Scatterlet scatterlet)
    {
        this.isValid = scatterlet.isValid;
        this.address = scatterlet.address;
        this.offsetes = Arrays.copyOf(scatterlet.offsetes, scatterlet.offsetes.length);
    ...
    public Scatterlet clone()
    {
        return new Scatterlet(this);
    }
